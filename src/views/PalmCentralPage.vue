...
const GHL_WEBHOOK =
	"https://services.leadconnectorhq.com/hooks/hRYeaoSXr2HJVUM9mbzj/webhook-trigger/581684b7-84a6-4dbf-a1e5-c0f1a096324a";

const HERO_IMG =
	"https://i.ibb.co/hF5CQwz5/7951f0f5-a3d0-4012-ada1-cac164e1dbfe.jpg";
const AERIAL_IMG =
	"https://www.nakheel.com/images/nakheelcorporatelibraries/construction-updates/palm-jebel-ali_banner1_apr-26.jpg?sfvrsn=324b30ac_1";
const AM_IMG =
	"https://www.cbnme.com/wp-content/uploads/2025/10/Palm-Central-Private-Residences-2.jpg";

const GALLERY_IMGS = [
	{
		src: "https://framerusercontent.com/images/qnAz5nphxSbU1y3L7HZ7HCGw.jpg?width=1920&height=1084",
		label: "Infinity Pool",
	},
	{
		src: "https://www.nakheel.com/images/nakheelcorporatelibraries/construction-updates/palm-jebel-ali_banner1_apr-26.jpg?sfvrsn=324b30ac_1",
		label: "Aerial View",
	},
	{
		src: "https://www.nakheel.com/images/nakheelcorporatelibraries/developments/projects/palm-central_image-03.jpg?sfvrsn=2eabbc59_1",
		label: "The Residences",
	},
	{
		src: "https://www.cbnme.com/wp-content/uploads/2025/10/Palm-Central-Private-Residences-2.jpg",
		label: "Private Beach",
	},
	{
		src: "https://thepalm-jebelali.com/wp-content/uploads/2025/10/Palm-central-master-plan.jpg",
		label: "Master Plan",
	},
	{
		src: "https://investindxb.com/palm-central/assets/pc-resort.jpg",
		label: "Community",
	},
];
...
function validate(): boolean {
	...
	errors.value.email = !isValidEmail(formData.value.email)
		...
		: "";
	errors.value.phone = !isValidUkPhone(formData.value.phone)
		? "Enter a valid UK number, e.g. 07700 900000."
		: "";
	errors.value.budget = !formData.value.budget
...
useHead({
	...
	meta: [
		{
			name: "description",
			content:
				"Exclusive beachfront apartments and townhouses on Palm Jebel Ali by Nakheel. 1–5 bedroom residences from £580,000. Register your interest — presented by Million Homes for UK investors.",
		},
		{
			name: "keywords",
			content:
				"Palm Central Nakheel, Palm Jebel Ali apartments, Dubai beachfront property, luxury Dubai real estate, off-plan Dubai investment, UK investors Dubai, Nakheel residences, Palm Jebel Ali townhouses",
		},
		{ property: "og:type", content: "website" },
		{
			property: "og:title",
			content: "Palm Central by Nakheel | Luxury Beachfront Residences",
		},
		{
			property: "og:description",
			content:
				"Exclusive beachfront apartments & townhouses from £580,000 on Palm Jebel Ali. Presented by Million Homes.",
		},
		{
			property: "og:image",
			content:
				"https://www.nakheel.com/images/nakheelcorporatelibraries/developments/projects/palm-central_image-03.jpg?sfvrsn=2eabbc59_1",
		},
		...
		{ name: "twitter:card", content: "summary_large_image" },
		{
			name: "twitter:title",
			content:
				"Palm Central by Nakheel | From £580,000 on Palm Jebel Ali",
		},
		{
			name: "twitter:description",
			content:
				"Beachfront apartments & townhouses on Palm Jebel Ali, Dubai. Tailored for UK investors.",
		},
		{
			name: "twitter:image",
			content:
	...
	link: [{ rel: "canonical", href: "https://millionhomes.ae/palm-central" }],
	script: [
		{
			...
			innerHTML: JSON.stringify({
				...
				description:
					"Exclusive beachfront apartments and townhouses on Palm Jebel Ali, Dubai, by Nakheel.",
				url: "https://millionhomes.ae/palm-central",
				image: HERO_IMG,
				address: {
					"@type": "PostalAddress",
					streetAddress: "Palm Jebel Ali",
	...
	<div class="pc" ref="pcContainer">
		...
		<section class="pc-hero" id="pc-hero" aria-label="Palm Central hero">
			<img
				class="pc-hero__bg"
				:src="HERO_IMG"
				alt="Palm Central Private Residences – beachfront exterior"
				fetchpriority="high"
				decoding="async"
				width="1920"
				height="1080"
			...
			<div class="pc-hero__body">
				<div class="pc-hero__left">
					<span class="pc-hero__eyebrow"
						>Exclusively Presented by Million Homes</span
					>
					<p class="pc-hero__brand-name">Palm Central by Nakheel</p>
					<div class="pc-hero__gold-rule" aria-hidden="true"></div>
					<h1 class="pc-hero__tagline">
						Beachfront apartment and townhouses on Palm Jebel Ali
					</h1>
					<p class="pc-hero__sub">
						From <strong>£580,000</strong> &nbsp;·&nbsp; 1–5 Bedroom
						Residences
					</p>
					<a href="#pc-form" class="pc-hero__outline-btn"
						>Register Interest</a
					>
				</div>

				<div
					class="pc-hero__glass"
					id="pc-form"
				...
				>
					<template v-if="!submitted">
						...
						>
							<div class="pc-glass-field">
								<label for="pc-name"
									>Full Name
									<span class="req" aria-label="required"
										>*</span
									></label
								>
								<input
							...
							<div class="pc-glass-field">
								...
								<div
									class="pc-phone-row"
									:class="{ 'pc-input-error': errors.phone }"
								>
					...
					>
						...
						<p>Thank You!</p>
						<small
							>Our team will contact you within 24 hours.</small
						>
					</div>
				</div>
			</div>
		...
		<section
			class="pc-about"
			id="pc-about"
			aria-labelledby="pc-about-title"
		>
			<div class="pc-about__left pc-animate">
				<span class="pc-eyebrow">About The Development</span>
				<h2 class="pc-about__title" id="pc-about-title">
					Palm Central Private Residences
				</h2>
				<div class="pc-gold-rule" aria-hidden="true"></div>
				<p class="pc-about__body">
					Palm Central Private Residences is a collection of
					contemporary resort-style homes across three elegant
					buildings at the very heart of Palm Jebel Ali. Situated
					between Fronds M and N, its stepped form opens each home to
					uninterrupted views of the island, from sunrise to
					starlight.
				</p>
				<p class="pc-about__body">
					Each residence is an expression of serenity and connection,
					defined by open layouts, natural textures, and a quiet
					prestige that reflects the essence of island life.
				</p>
				<a href="#pc-form" class="pc-about__brochure"
					>Download Brochure</a
				>
			</div>
			<div class="pc-about__right pc-animate pc-animate--d2">
				<img
					:src="AERIAL_IMG"
					alt="Aerial masterplan view of Palm Jebel Ali"
					loading="lazy"
					decoding="async"
					width="1200"
					height="800"
		...
		<section
			class="pc-payment"
			id="pc-payment"
			aria-labelledby="pc-payment-title"
		>
			<div class="pc-payment__inner">
				<span class="pc-eyebrow pc-animate">Flexible Finance</span>
				<h2 class="pc-payment__title pc-animate" id="pc-payment-title">
					Payment Plan
				</h2>
				<div
					class="pc-gold-rule pc-gold-rule--center pc-animate"
					aria-hidden="true"
				></div>
				<div class="pc-pay-cards">
					<div class="pc-pay-card pc-animate">
						<svg
							class="pc-pay-card__icon"
							viewBox="0 0 24 24"
							fill="none"
							stroke="currentColor"
							stroke-width="1.4"
					...
					<div class="pc-pay-card pc-animate pc-animate--d1">
						...
						>
							<path
								d="M3 21h18M9 21V7l3-4 3 4v14M5 21V11l4-2M19 21V11l-4-2"
							/>
						</svg>
					...
					<div class="pc-pay-card pc-animate pc-animate--d2">
						...
						>
							<path
								d="M20 7H4a2 2 0 00-2 2v6a2 2 0 002 2h16a2 2 0 002-2V9a2 2 0 00-2-2zM12 12m-1 0a1 1 0 102 0 1 1 0 00-2 0"
							/>
						</svg>
				...
				<a href="#pc-form" class="pc-pay-cta pc-animate"
					>Request Full Payment Plan</a
				>
			</div>
		</section>
		...
		<section
			class="pc-amenities"
			id="pc-amenities"
			aria-labelledby="pc-amenities-title"
		>
			<div
				class="pc-am-bg"
				:style="{ backgroundImage: `url('${AM_IMG}')` }"
				role="img"
				aria-label="Palm Central resort amenities"
			></div>
			<div class="pc-am-veil"></div>
			<div class="pc-amenities__inner">
				<span class="pc-eyebrow pc-eyebrow--light pc-animate"
					>World-Class Living</span
				>
				<h2
					class="pc-amenities__title pc-animate"
					id="pc-amenities-title"
				>
					More Than a Destination,<br />It's a State of Mind
				</h2>
				<div
					class="pc-gold-rule pc-gold-rule--center pc-animate"
					aria-hidden="true"
				...
				<div class="pc-am-grid" role="list">
					<div
						class="pc-am-item pc-animate"
						v-for="(am, i) in amenities"
						:key="am.name"
						:class="`pc-animate--d${i}`"
						role="listitem"
					>
		...
		<section
			class="pc-gallery"
			id="pc-gallery"
			aria-labelledby="pc-gallery-title"
		>
			<span class="pc-eyebrow pc-animate">Visual Journey</span>
			<h2 class="pc-gallery__title pc-animate" id="pc-gallery-title">
				Photo Gallery
			</h2>
			<div
				class="pc-gold-rule pc-gold-rule--center pc-animate"
			...
			<div class="pc-gallery__grid">
				<figure
					class="pc-gallery__item pc-animate"
					v-for="(g, i) in GALLERY_IMGS"
					:key="g.label"
					:class="`pc-animate--d${Math.min(i, 3)}`"
				>
					<img
						:src="g.src"
						:alt="`Palm Central – ${g.label}`"
						loading="lazy"
						decoding="async"
						width="800"
						height="600"
					/>
					<figcaption class="pc-gallery__label">
						{{ g.label }}
					</figcaption>
				</figure>
			</div>
		...
		<section class="pc-pricing" aria-labelledby="pc-pricing-title">
			<div class="pc-pricing__inner">
				...
				<h2 class="pc-pricing__title pc-animate" id="pc-pricing-title">
					Unit Types &amp; Prices
				</h2>
				<div
					class="pc-gold-rule pc-gold-rule--center pc-animate"
				...
				></div>
				<div
					class="pc-pricing__table"
					role="table"
					aria-label="Unit types and prices"
				>
					<div
						class="pc-price-row pc-animate"
						v-for="(u, i) in units"
						:key="u.type"
						:class="`pc-animate--d${Math.min(i, 4)}`"
						role="row"
					>
				...
				<a href="#pc-form" class="pc-pricing__btn pc-animate"
					>Request Full Pricing</a
				>
			</div>
		</section>
		...
		<section class="pc-cta" aria-label="Register interest call to action">
			<div
				...
				role="img"
				aria-label="Palm Jebel Ali aerial view"
			></div>
			<div class="pc-cta__veil"></div>
			<div class="pc-cta__inner pc-animate">
				<p class="pc-cta__sub">
					Secure your beachfront residence on Palm Jebel Ali today.
				</p>
		...
		<section class="pc-dev" aria-labelledby="pc-dev-name">
			<div class="pc-dev__inner pc-animate">
				...
				<div
					class="pc-gold-rule pc-gold-rule--center"
					aria-hidden="true"
				></div>
				<p class="pc-dev__tagline">Global Lifestyle Developer</p>
				<p class="pc-dev__body">
					Nakheel is one of the world's leading real estate
					developers, responsible for some of Dubai's most iconic
					projects. From Palm Jumeirah to Palm Jebel Ali, Nakheel
					continues to shape the skyline and shoreline of the UAE with
					visionary communities designed for exceptional living.
				</p>
			</div>
		</section>
		...
		<footer class="pc-footer" role="contentinfo">
			...
			<p class="pc-footer__disc">
				This page is for informational purposes only. All prices, areas,
				payment schedules, and images are indicative and subject to
				change by the developer (Nakheel) without notice.
			</p>
		</footer>

		<!-- ══ MOBILE STICKY CTA ════════════════════════════════════════════ -->
		<div class="pc-sticky-cta" aria-label="Quick enquiry">
			<a href="#pc-form" class="pc-sticky-cta__btn"
...
.pc-glass-field select:focus {
	box-shadow:
		inset 0 0 0 1px var(--gold-l),
		0 0 0 3px rgba(196, 163, 90, 0.2);
	background: #ffffff;
}
.pc-glass-field input::placeholder {
	color: rgba(22, 19, 14, 0.36);
}
.pc-glass-field select {
	cursor: pointer;
	color: rgba(22, 19, 14, 0.42);
}
.pc-glass-field select:valid {
	color: var(--ink);
}
...
.pc-phone-row.pc-input-error {
	box-shadow:
		...
		0 0 0 2px rgba(220, 38, 38, 0.14) !important;
	border-radius: 2px;
}
.pc-field-error {
	font-size: 0.63rem;
...
.pc-glass-form button:hover:not(:disabled) {
	background: var(--gold-l);
	transform: translateY(-1px);
}
.pc-glass-form button:active:not(:disabled) {
	transform: translateY(0);
}
.pc-glass-form button:disabled {
	opacity: 0.5;
	cursor: not-allowed;
}
...
.pc-pay-card:hover {
	...
	box-shadow:
		...
		0 14px 36px rgba(18, 15, 10, 0.09);
}
.pc-pay-card__icon {
	width: 26px;
	height: 26px;
...
.pc-gallery__item:hover .pc-gallery__label {
	transform: translateY(0);
}
...
.pc-price-row:last-child {
	border-bottom: none;
}
.pc-price-row span:first-child {
	color: var(--stone);
	font-weight: 300;
}
...
.pc-footer p:first-child strong {
